...
class GasTracking(models.Model):
    ...
    name = fields.Char(string='Tracking Number', required=True, copy=False, readonly=True, index=True, default=lambda self: self.env['ir.sequence'].next_by_code('gas.tracking'))
